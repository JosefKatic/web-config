{
  ...
  in {
    devShells = eachSystem (system: import ./shell.nix {pkgs = nixpkgs.legacyPackages.${system};});
      ...
      frontend = dream2nix.lib.evalModules {
        ...
        modules = [
          ...
          ./nix/frontend/default.nix
          {
            ...
            paths.projectRoot = gitignore.lib.gitignoreSource ./joka00.dev;
            # can be changed to ".git" or "flake.nix" to get rid of .project-root
            paths.projectRootFile = "flake.nix";
            paths.package = ./joka00.dev;
          }
        ];
      };
